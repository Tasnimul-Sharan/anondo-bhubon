...
//               >
//                 <div className="relative aspect-[4/3] min-h-[360px] overflow-hidden bg-primary/10 sm:aspect-[16/9] lg:aspect-[16/7] lg:min-h-[560px]">
//                   <Image
//                     src={item.image}
//                     alt={item.title}
//                     fill
...
//                   <p className="mt-5 max-w-4xl text-base font-medium leading-8 text-primary/72">
//                     {item.description ||
...
//                       <div className="relative h-[3px] w-full max-w-[220px] overflow-hidden bg-primary/10">
